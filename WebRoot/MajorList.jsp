	...
	<body>
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar">
					<li>
						<a href="../MajorAdd.jsp"><span><img src="../images/t01.png" /> </span>添加</a>
					</li>
					<li>
			...
			<table class="tablelist">
				...
				<tbody>
					<c:forEach var="m" items="${majors}" varStatus="i">
						<tr>
							<td>
								<input name="" id="id" type="checkbox" value="${m.id }" />
							</td>
							<td>
								${i.count }
							</td>
							...
							<td class="td_w">
								<a href="findByid?id=${m.id }" class="updatetc"><img src="../images/t02.png" />修改</a>
							</td>
							<td class="td_w">
