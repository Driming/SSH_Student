...
<div class="modal fade" id="UpdateDeptDeptModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:80%;"> 
        <div class="modal-content">
            ...
            <form class="form-horizontal">
                <table class="table tasod"  width="100%">
                    <tr>
                        ...
                        <td>
                        <p class="form-control-static" id="Updatedeptname"></p>
                       
                        </td>
                        <td width="100px;">部门领导：</td>
                         <td><input type="text" class="form-control faoosd" id="Updateleadername" name="leadername">
                    ...
                    <tr>
                    	<td>上级部门：</td>
                    	<td  colspan="3">
                    		<select style="width:400px;" class="form-control" name="updept" id="dept_Update_select">
				   			</select>
                    	</td>
                    </tr>
                    <tr>
                        <td>部门职责：</td>
                        <td colspan="3"><textarea rows="3" cols="100%" id="Updatedutydept" name="dutydept"></textarea></td>
                    </tr>
                    <tr>
                    	<td>人员上限：</td>
                    	<td><input type="text" class="form-control faoosd" id="Updateuplingnum" name="uplingnum">
                    	<span class="help-block"></span></td>
                    	<td>尚需人数：</td>
                    	<td><input type="text" class="form-control faoosd" id="Updatepeoplenum" name="peoplenum">
                    	<span class="help-block"></span></td>
                    </tr>
                    <tr>
                    	<td>办公地址：</td>
                    	<td><input type="text" class="form-control faoosd" id="Updateaddress" name="address">
                    	<span class="help-block"></span></td>
                    	<td>办公电话：</td>
                    	<td><input type="text" class="form-control faoosd" id="Updatedeptphone" name="deptphone">
                    	<span class="help-block"></span></td>
                    	
                    </tr>
                    <tr>
                    	<td>传真号码：</td>
                    	<td colspan="3"><input type="text" class="form-control faoosd" id="Updatefacsimile" name="facsimile">
                    	<span class="help-block"></span></td>
                    </tr>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="Update_dept" class="btn btn-primary">
                  		 更新
                </button>
            </div>
        </div>
    ...
    <div class="modal-dialog" style="width:80%;"> 
        <div class="modal-content">
            ...
            <form class="form-horizontal">
                <table class="table tasod"  width="100%">
                    <tr>
                        <td width="100px;">部门名称：</td>
                        <td>
                            <input type="text" class="form-control faoosd" id="add_deptname" name="deptname">
                            <span class="help-block"></span>
                        </td>
                        <td width="100px;">部门领导：</td>
                         <td><input type="text" class="form-control faoosd" id="add_leadername" name="leadername">
                         <span class="help-block"></span></td>
                    ...
                    <tr>
                    	<td>上级部门：</td>
                    	<td  colspan="3">
                    		<select style="width:400px;" class="form-control" name="updept" id="dept_add_select">
				   			</select>
                    	</td>
                    </tr>
                    <tr>
                        <td>部门职责：</td>
                        <td colspan="3"><textarea rows="3" cols="100%" id="add_dutydept" name="dutydept"></textarea></td>
                    </tr>
                    <tr>
                    	<td>人员上限：</td>
                    	<td><input type="text" class="form-control faoosd" id="add_uplingnum" name="uplingnum">
                    	<span class="help-block"></span></td>
                    	<td>办公地址：</td>
                    	<td><input type="text" class="form-control faoosd" id="add_address" name="address">
                    	<span class="help-block"></span></td>
                    </tr>
                    <tr>
                    	<td>办公电话：</td>
                    	<td><input type="text" class="form-control faoosd" id="add_deptphone" name="deptphone">
                    	<span class="help-block"></span></td>
                    	<td>传真号码：</td>
                    	<td><input type="text" class="form-control faoosd" id="add_facsimile" name="facsimile">
                    	<span class="help-block"></span></td>
                    </tr>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="save_dept" class="btn btn-primary">
                  		  保存
                </button>
            </div>
        </div>
